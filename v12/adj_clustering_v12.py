...
if __name__ == '__main__':
    ...
    for filename in ['blue','hot']:#os.listdir(ADJ_DIC_FOLDER):
        ...
        try:
            first_clustering_k = int(0.01* len(filtered_contexts_list))
            ...
            final_labeling = [clustering_alg.labels_[first_clustering.labels_[i]] for i in xrange(0, len(filtered_contexts_list))]
