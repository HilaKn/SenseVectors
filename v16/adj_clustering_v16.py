...
if __name__ == '__main__':
    ...
    for filename in ['blue','hot','long','right']:#os.listdir(ADJ_DIC_FOLDER):
        ...
        try:
            ...
            print "KMEANS clustering [{}]".format(adj)
            clustering_alg=KMeans(n_clusters=K_CLUSTERS, random_state=0).fit(clustering_input)
            print "done clustering [{}] with [{}] clusters".format(adj,K_CLUSTERS)
            ...
            if (args.analyze_adj_clusters):
                ...
                output_clusters(K_CLUSTERS,final_labeling)
